...
public class MySqlConexion {
    ...
    public static void setDatos(String url, String nombreServidor, String numeroPuerto, String nombreBaseDato, String nombreUsuario, String clave) {
        MySqlConexion.url = url;
    }
